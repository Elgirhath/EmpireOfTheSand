...
{
    public class GatheringRangeResolver
    {
        private Tilemap tilemap;
        private Vector3 tilemapRightVector;
        private Vector3 tilemapUpVector;

        public GatheringRangeResolver(Tilemap tilemap)
        {
        ...
        public bool IsPointInGatheringRange(Vector3Int tilePosition, Vector3 point, float range)
        {
